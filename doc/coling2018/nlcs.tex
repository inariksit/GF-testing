...
Table~\ref{results_indiv} shows what happens when we ran our tool on some example functions from the resource grammar, and Table~\ref{results} shows the number of generated trees in total for all syntactic functions in the two grammars.
...
\multicolumn{3}{|r}{Concrete $\rightarrow$}              &
  ...
  $\downarrow$ Abstract  & \#funs+lex & \#trees
   ...
   & 21,370  & 19,825 &  13733  & 9194    &   & \\ \hline
\end{tabular}
...
sentences as Dutch, but other resource grammarians have reported
